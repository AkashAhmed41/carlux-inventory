...
export const EmptyIcon = ({ className }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const ShieldCheckIcon = ({ className = "w-3 h-3" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const TruckIcon = ({ className = "w-3 h-3" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const BoxIcon = ({ className = "w-3 h-3" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
